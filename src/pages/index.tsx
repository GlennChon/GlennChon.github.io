...
const Lights = () => {
  ...
  return (
    <>
      <ambientLight intensity={.02} color={colors.white} />
      <spotLight intensity={.02} color={colors.white} position={[50, 100, 200]}
        distance={30}
        angle={Math.PI * 0.05}
        penumbra={0.25}
        decay={0.5} />
      <hemisphereLight intensity={.5} groundColor={colors.darkGray} />
      <directionalLight
        ref={dirLight}
        target={o}
        color={colors.white}
...
const Composition = () => {
  ...
  return (
    <group ref={groupRef}>
      <fog attach="fog" args={[colors.black, -5, 800]} />
      <Lights />
